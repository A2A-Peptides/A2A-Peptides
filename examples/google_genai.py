"""A2A Peptides — google-genai (stock) with the door's tools as function declarations; the MCP ClientSession dispatches the call.
...
PROMPT = "Call gate_transaction with substance semaglutide, pathway licensed_medicine, actor_class wholesale_distributor, ship_to US-CA."
